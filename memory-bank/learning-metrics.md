...
| TASK-008 | 2026-06-30 | 4 | 4 | 0 |

## Rule Effectiveness

| File | Topics | Evidence Count | Priority | Last Updated |
|------|--------|---------------:|:--------:|:------------:|
| testing-patterns.md | testing, jest, logging, mocking, e2e, playwright, realtime | 7 | medium | 2026-06-30 |
| api-design.md | api-design, express, testability, routing, migrations, deployment | 5 | medium | 2026-06-30 |
...
| frontend.md | frontend, react, data-fetching, error-handling, realtime | 5 | medium | 2026-06-30 |
| realtime.md | realtime, sse, transport, backend, architecture | 2 | low | 2026-06-30 |
